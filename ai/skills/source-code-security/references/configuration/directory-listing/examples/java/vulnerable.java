...
public class DirectoryListingExample {
    @PostMapping("/example/directory-listing")
    public Map<String, Object> handle(@RequestBody Map<String, Object> body, User user) {
        // Vulnerable Directory Listing / Static Asset Exposure: request-controlled data is trusted before authorization/validation.
