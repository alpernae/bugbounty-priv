...
| Field | Value |
| --- | --- |
| HackerOne weakness | Information Exposure Through Directory Listing |
| CWE / external ID | CWE-548 |
| OWASP / WSTG / API mapping | WSTG-CONF-04 |

## What to look for

Web server exposes index listing of files/directories.
...
<a href="db-backup-2024.sql.gz">db-backup-2024.sql.gz</a>
```
...
List minimal filenames only; do not download large/sensitive backups unless program permits.

## Remediation direction

Disable autoindex, restrict sensitive directories, and remove backups from web-accessible paths.
