# Exposed Backup / Unreferenced Files
...
| Field | Value |
| --- | --- |
| HackerOne weakness | File and Directory Information Exposure |
| CWE / external ID | CWE-538 |
| OWASP / WSTG / API mapping | WSTG-CONF-04 |

## What to look for

Backup, temporary, old, or unreferenced files are web-accessible.
...
Redact secrets and capture file path, status, and sensitive content category.

## Remediation direction

Remove backup files from webroot, block dangerous extensions, and add deployment checks.
