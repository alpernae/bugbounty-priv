# Predictable Security Token / Weak Randomness
...
| Field | Value |
| --- | --- |
| HackerOne weakness | Use of Insufficiently Random Values |
| CWE / external ID | CWE-330 |
| OWASP / WSTG / API mapping | WSTG-SESS-01 |

## What to look for

Session/reset/invite tokens are predictable, sequential, low entropy, or reused.
...
{"invite_url":"https://target.example/invite/100001"}

# Next invite returns /invite/100002
```
...
{"invite_url":"https://target.example/invite/b4Jf9aP0s2..."}
```

## Evidence to collect

Show sequence/predictability using only owned generated tokens.

## Remediation direction

Use cryptographically secure random tokens with sufficient entropy and expiration; bind tokens to purpose/user.
