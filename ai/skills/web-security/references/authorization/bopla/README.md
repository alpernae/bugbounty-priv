...
| CWE / external ID | CWE-863 |
| OWASP / WSTG / API mapping | API3 BOPLA |

## What to look for

User can read or change object properties they should not access, even if object access itself is allowed.
...
{"email":"me@example.com","risk_score":0,"email_verified":true}
```
...
{"id":123,"email":"me@example.com","risk_score":0,"email_verified":true}
```
...
{"error":"forbidden_properties: risk_score,email_verified"}
```

## Evidence to collect

Show object owner is valid but sensitive property should be immutable/hidden.

## Remediation direction

Apply property-level read/write authorization and separate public DTOs from internal models.
