...
| OWASP / WSTG / API mapping | API1 BOLA |

## What to look for

GraphQL resolver fails object-level authorization.
...
{"query":"query { invoice(id:"inv_user_b") { id ownerEmail amount } }"}
```
...
{"data":{"invoice":{"id":"inv_user_b","ownerEmail":"userb@example.com","amount":"129.00"}}}
```
...
{"data":{"invoice":null},"errors":[{"message":"not_authorized"}]}
```

## Evidence to collect

Use two owned accounts. Show resolver returns other account data.

## Remediation direction

Add object-level authorization inside every resolver/data loader; do not rely on frontend queries.
