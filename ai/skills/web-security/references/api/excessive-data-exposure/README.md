...
| OWASP / WSTG / API mapping | API3 Excessive Data Exposure |

## What to look for

API returns sensitive fields that the client does not need or is not authorized to see.
...
{"id":123,"name":"A","email":"a@example.com","password_hash":"REDACTED_HASH","mfa_secret":"REDACTED"}
```
...
{"id":123,"name":"A","email":"a@example.com"}
```

## Evidence to collect

Redact secrets in report. Show field is returned over API even if frontend hides it.

## Remediation direction

Use response DTOs, deny sensitive fields by default, and enforce property-level authorization.
