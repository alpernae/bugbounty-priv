...
| Field | Value |
| --- | --- |
| HackerOne weakness | Improper Access Control - Generic |
| CWE / external ID | CWE-284 |
| OWASP / WSTG / API mapping | WSTG-CLNT-07 |

## What to look for

API reflects arbitrary Origin and allows credentials, enabling attacker origins to read authenticated responses.
...
Capture Origin, ACAO, ACAC, and readable sensitive response from a browser PoC.

## Remediation direction

Use exact origin allowlists, never reflect arbitrary origins, avoid credentials unless necessary, and set Vary: Origin.
