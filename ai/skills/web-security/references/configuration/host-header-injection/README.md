...
| Field | Value |
| --- | --- |
| HackerOne weakness | Improper Neutralization of HTTP Headers for Scripting Syntax |
| CWE / external ID | CWE-644 |
| OWASP / WSTG / API mapping | WSTG-CONF-07 |

## What to look for

Application uses untrusted Host/X-Forwarded-Host in links, redirects, password reset, or cache keys.
...
<link rel="canonical" href="https://attacker.example/account">
```
...
Show concrete impact: poisoned links, reset link poisoning, cache poisoning, or routing issue.

## Remediation direction

Validate Host against configured allowlist and generate absolute URLs from trusted config.
