...
| Field | Value |
| --- | --- |
| HackerOne weakness | Exposed Dangerous Method or Function |
| CWE / external ID | CWE-749 |
| OWASP / WSTG / API mapping | WSTG-CONF-06 |

## What to look for

Unsafe HTTP methods such as PUT/DELETE/TRACE are enabled without proper need/authz.
...
Show enabled methods and demonstrate impact only with safe test path if allowed.

## Remediation direction

Disable unused methods, block TRACE, and require authorization for state-changing methods.
