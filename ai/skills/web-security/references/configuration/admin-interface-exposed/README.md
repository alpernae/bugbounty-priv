...
| OWASP / WSTG / API mapping | WSTG-CONF-05 |

## What to look for

Admin/internal management interface is internet-accessible and weakly protected.
...
<title>Admin Console</title><form id="login">...</form>
```
...
Do not attempt credential attacks. Show exposure, product/version if visible, and missing network restrictions.

## Remediation direction

Restrict by VPN/IP/SSO/MFA, remove default credentials, and monitor admin login attempts.
