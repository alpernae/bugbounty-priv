...
| OWASP / WSTG / API mapping | WSTG-CONF-11 |

## What to look for

Cloud/object storage is publicly listable or readable beyond intended files.

## Vulnerable request

```http
GET /?list-type=2 HTTP/1.1
Host: assets-bucket.storage.example
```
...
<ListBucketResult><Contents><Key>private/users.csv</Key></Contents></ListBucketResult>
```
...
List minimal object names; do not download sensitive files unless authorized. Redact data.

## Remediation direction

Disable public listing/read, use bucket policies least privilege, and separate public assets from private data.
