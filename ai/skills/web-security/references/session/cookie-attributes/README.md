...
| OWASP / WSTG / API mapping | WSTG-SESS-02 |

## What to look for

Session cookies miss Secure, HttpOnly, SameSite, or scoped Domain/Path controls.
...
Capture Set-Cookie header and explain concrete impact from missing attribute.

## Remediation direction

Set Secure, HttpOnly, SameSite, minimal Domain/Path, and appropriate expiration for all sensitive cookies.
