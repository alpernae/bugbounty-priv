...
| Field | Value |
| --- | --- |
| HackerOne weakness | Deserialization of Untrusted Data |
| CWE / external ID | CWE-502 |
| OWASP / WSTG / API mapping | WSTG-INPV-20 |

## What to look for

Application deserializes user-controlled objects without integrity validation or safe type restrictions.
...
Cookie: prefs=eyJjbGFzcyI6IlByb29mIiwibWVzc2FnZSI6IjcqeCJ9
...
{"deserialized_class":"Proof","message":"unsafe_type_loaded"}
```
...
{"error":"invalid_or_unsigned_preferences"}
```

## Evidence to collect

Use non-executing proof objects only; do not include gadget chains or RCE payloads.

## Remediation direction

Do not deserialize untrusted objects, use signed/encrypted simple data formats, restrict allowed classes, and patch libraries.
