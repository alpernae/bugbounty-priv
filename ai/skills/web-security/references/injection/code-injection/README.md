...
User input is evaluated as dynamic application code.
...
{"error":"expressions_not_allowed"}
```

## Evidence to collect

Keep proof to arithmetic/string evaluation; do not execute OS commands or access files.

## Remediation direction

Remove eval-like behavior, use safe parsers/DSLs, sandbox strictly, and constrain template functionality.
