...
| OWASP / WSTG / API mapping | WSTG-INPV-18 |

## What to look for

Template engine renders user-controlled template syntax server-side.
...
Show arithmetic evaluation only. Do not include sandbox escape chains in initial report.

## Remediation direction

Do not render user input as templates; use plain variables, sandbox cautiously, and restrict template features.
