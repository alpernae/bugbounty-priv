...
Client controls price/discount/quantity fields that should be calculated server-side.
...
{"sku":"PRO_PLAN","quantity":1,"unit_price":0.01}
```
...
{"order_id":"ord_test","charged":"0.01","sku":"PRO_PLAN"}
```
...
{"error":"client_price_not_allowed","server_price":"29.00"}
```

## Evidence to collect

Use sandbox/test purchase only. Show server accepted client-supplied price.

## Remediation direction

Calculate prices server-side from trusted catalog, sign quotes, and verify payment processor amounts.
